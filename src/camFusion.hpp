...
void clusterKptMatchesWithROI(BoundingBox &boundingBox, BoundingBox &boundingBox_b,  std::vector<cv::KeyPoint> &kptsPrev, std::vector<cv::KeyPoint> &kptsCurr, std::vector<cv::DMatch> &kptMatches);
